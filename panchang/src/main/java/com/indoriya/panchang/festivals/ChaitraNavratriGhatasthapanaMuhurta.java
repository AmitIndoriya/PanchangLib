...
public class ChaitraNavratriGhatasthapanaMuhurta {
    public ChaitraNavratriGhatasthapanaMuhurta() {
    }

    public static double[] findChaitraNavratriGhatasthapanaMuhurta(int ghatasthapanaDateJd, Place place) {
    ...
    public static void main(String[] args) {
        ...
        findChaitraNavratriGhatasthapanaMuhurta(jd, NewDelhi);
    }
}
