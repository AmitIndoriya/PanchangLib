...
public class EkadashiShuklaPakshaMuhurta {
    public EkadashiShuklaPakshaMuhurta() {
    }

    public static double[] findShuklaKrishnaPakshaMuhurta(int ekadashiDateJd, Place place) {
    ...
    public static void main(String[] args) {
        ...
        int jd = (int)Masa.toJulian(2018, 7, 23);
        double[] muhurta = findShuklaKrishnaPakshaMuhurta(jd, NewDelhi);
