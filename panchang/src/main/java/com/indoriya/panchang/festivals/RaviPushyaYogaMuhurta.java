...
public class RaviPushyaYogaMuhurta {
    public RaviPushyaYogaMuhurta() {
    }

    public static double[] findRaviPushyaYogaMuhurta(double jdNak, Place place) {
    ...
    public static void main(String[] args) {
        ...
        double[] muhurta = findRaviPushyaYogaMuhurta((double)jd, NewDelhi);
