...
public class SunTimes {
    ...
    private static Time getTimeUTC(int var0, int var1, int var2, double var3, double var5, double var7, int var9) throws SunTimesException {
    ...
    public static Time getSunriseTimeUTC(int var0, int var1, int var2, double var3, double var5, double var7) throws SunTimesException {
        return getTimeUTC(var0, var1, var2, var3, var5, var7, 0);
    }

    public static Time getSunsetTimeUTC(int var0, int var1, int var2, double var3, double var5, double var7) throws SunTimesException {
